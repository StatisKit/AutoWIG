...
setup(packages = packages.keys(),
      ...
      entry_points = {
        ...
        'autowig.pybind11_call_policy': ['default = autowig.boost_python_generator:boost_python_default_call_policy'],
        'autowig.pybind11_export': ['custom = autowig.pybind11_generator:PyBind11ExportFileProxy',
                                    'default = autowig.pybind11_generator:PyBind11ExportDefaultFileProxy'],
