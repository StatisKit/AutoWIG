...
void export_class_clang__dependent_template_specialization_type()
{
    ...
    boost::python::class_< ::clang::DependentTemplateSpecializationType, ::clang::DependentTemplateSpecializationType*, boost::python::bases< ::clang::TypeWithKeyword, ::llvm::FoldingSetNode >, boost::noncopyable >("DependentTemplateSpecializationType", boost::python::no_init);
}