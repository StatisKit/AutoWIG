...
void export_class_clang_type_alias_template_decl()
{
    ...
    boost::python::class_< ::clang::TypeAliasTemplateDecl, ::clang::TypeAliasTemplateDecl *, boost::python::bases< ::clang::RedeclarableTemplateDecl >, boost::noncopyable >("TypeAliasTemplateDecl", boost::python::no_init);
}