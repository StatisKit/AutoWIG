...
void export_class_clang__dependent_name_type()
{
    ...
    boost::python::class_< ::clang::DependentNameType, ::clang::DependentNameType*, boost::python::bases< ::clang::TypeWithKeyword, ::llvm::FoldingSetNode >, boost::noncopyable >("DependentNameType", boost::python::no_init);
}