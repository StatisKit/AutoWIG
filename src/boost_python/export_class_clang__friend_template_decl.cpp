...
void export_class_clang__friend_template_decl()
{
    ...
    boost::python::class_< ::clang::FriendTemplateDecl, ::clang::FriendTemplateDecl*, boost::python::bases< ::clang::Decl >, boost::noncopyable >("FriendTemplateDecl", boost::python::no_init);
}