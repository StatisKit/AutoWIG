...
void export_class_clang_redeclarable_template_decl()
{
    ...
    boost::python::class_< ::clang::RedeclarableTemplateDecl, ::clang::RedeclarableTemplateDecl *, boost::python::bases< ::clang::TemplateDecl >, boost::noncopyable >("RedeclarableTemplateDecl", boost::python::no_init);
}