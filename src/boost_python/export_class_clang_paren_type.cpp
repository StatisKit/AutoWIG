...
void export_class_clang_paren_type()
{
    ...
    boost::python::class_< ::clang::ParenType, ::clang::ParenType *, boost::python::bases< ::clang::Type, ::llvm::FoldingSetNode >, boost::noncopyable >("ParenType", boost::python::no_init);
}