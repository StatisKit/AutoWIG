...
void export_class_clang__obj_cat_defs_field_decl()
{
    ...
    boost::python::class_< ::clang::ObjCAtDefsFieldDecl, ::clang::ObjCAtDefsFieldDecl*, boost::python::bases< ::clang::FieldDecl >, boost::noncopyable >("ObjCAtDefsFieldDecl", boost::python::no_init);
}