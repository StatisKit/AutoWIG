...
void export_class_clang_static_assert_decl()
{
    ...
    boost::python::class_< ::clang::StaticAssertDecl, ::clang::StaticAssertDecl *, boost::python::bases< ::clang::Decl >, boost::noncopyable >("StaticAssertDecl", boost::python::no_init);
}