...
void export_class_clang__dependent_type_of_expr_type()
{
    ...
    boost::python::class_< ::clang::DependentTypeOfExprType, ::clang::DependentTypeOfExprType*, boost::python::bases< ::clang::TypeOfExprType, ::llvm::FoldingSetNode >, boost::noncopyable >("DependentTypeOfExprType", boost::python::no_init);
}