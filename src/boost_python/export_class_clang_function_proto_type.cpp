...
void export_class_clang_function_proto_type()
{
    ...
    boost::python::class_< ::clang::FunctionProtoType, ::clang::FunctionProtoType *, boost::python::bases< ::clang::FunctionType, ::llvm::FoldingSetNode >, boost::noncopyable >("FunctionProtoType", boost::python::no_init);
}