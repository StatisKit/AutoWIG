...
void export_class_clang_cxxconstructor_decl()
{
    ...
    boost::python::class_< ::clang::CXXConstructorDecl, ::clang::CXXConstructorDecl *, boost::python::bases< ::clang::CXXMethodDecl >, boost::noncopyable >("CXXConstructorDecl", boost::python::no_init);
}