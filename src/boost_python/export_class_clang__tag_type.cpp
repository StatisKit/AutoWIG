...
void export_class_clang__tag_type()
{
    ...
    boost::python::class_< ::clang::TagType, ::clang::TagType*, boost::python::bases< ::clang::Type >, boost::noncopyable >("TagType", boost::python::no_init)
        .def("get_decl", &::clang::TagType::getDecl, boost::python::return_value_policy< boost::python::reference_existing_object >());
}