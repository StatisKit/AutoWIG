...
void export_class_clang__block_pointer_type()
{
    ...
    boost::python::class_< ::clang::BlockPointerType, ::clang::BlockPointerType*, boost::python::bases< ::clang::Type, ::llvm::FoldingSetNode >, boost::noncopyable >("BlockPointerType", boost::python::no_init);
}