...
void export_class_clang__pretty_stack_trace_decl()
{
    ...
    boost::python::class_< ::clang::PrettyStackTraceDecl, ::clang::PrettyStackTraceDecl*, boost::python::bases< ::llvm::PrettyStackTraceEntry >, boost::noncopyable >("PrettyStackTraceDecl", boost::python::no_init);
}