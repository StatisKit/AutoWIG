...
void export_class_clang_extern_ccontext_decl()
{
    ...
    boost::python::class_< ::clang::ExternCContextDecl, ::clang::ExternCContextDecl *, boost::python::bases< ::clang::Decl, ::clang::DeclContext >, boost::noncopyable >("ExternCContextDecl", boost::python::no_init);
}