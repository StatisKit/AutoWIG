...
void export_class_clang_captured_decl()
{
    ...
    boost::python::class_< ::clang::CapturedDecl, ::clang::CapturedDecl *, boost::python::bases< ::clang::Decl, ::clang::DeclContext >, boost::noncopyable >("CapturedDecl", boost::python::no_init);
}