...
void export_class_clang__obj_cinterface_decl()
{
    ...
    boost::python::class_< ::clang::ObjCInterfaceDecl, ::clang::ObjCInterfaceDecl*, boost::python::bases< ::clang::ObjCContainerDecl >, boost::noncopyable >("ObjCInterfaceDecl", boost::python::no_init);
}