...
void export_class_clang__attributed_type()
{
    ...
    boost::python::class_< ::clang::AttributedType, ::clang::AttributedType*, boost::python::bases< ::clang::Type, ::llvm::FoldingSetNode >, boost::noncopyable >("AttributedType", boost::python::no_init);
}