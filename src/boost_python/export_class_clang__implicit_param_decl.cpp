...
void export_class_clang__implicit_param_decl()
{
    ...
    boost::python::class_< ::clang::ImplicitParamDecl, ::clang::ImplicitParamDecl*, boost::python::bases< ::clang::VarDecl >, boost::noncopyable >("ImplicitParamDecl", boost::python::no_init);
}