...
void export_class_clang__obj_cimplementation_decl()
{
    ...
    boost::python::class_< ::clang::ObjCImplementationDecl, ::clang::ObjCImplementationDecl*, boost::python::bases< ::clang::ObjCImplDecl >, boost::noncopyable >("ObjCImplementationDecl", boost::python::no_init);
}