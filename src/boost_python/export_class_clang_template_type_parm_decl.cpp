...
void export_class_clang_template_type_parm_decl()
{
    ...
    boost::python::class_< ::clang::TemplateTypeParmDecl, ::clang::TemplateTypeParmDecl *, boost::python::bases< ::clang::TypeDecl >, boost::noncopyable >("TemplateTypeParmDecl", boost::python::no_init);
}