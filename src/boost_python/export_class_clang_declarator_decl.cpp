...
void export_class_clang_declarator_decl()
{
    ...
    boost::python::class_< ::clang::DeclaratorDecl, ::clang::DeclaratorDecl *, boost::python::bases< ::clang::ValueDecl >, boost::noncopyable >("DeclaratorDecl", boost::python::no_init);
}