...
void export_class_clang__var_template_specialization_decl()
{
    ...
    boost::python::class_< ::clang::VarTemplateSpecializationDecl, ::clang::VarTemplateSpecializationDecl*, boost::python::bases< ::clang::VarDecl, ::llvm::FoldingSetNode >, boost::noncopyable >("VarTemplateSpecializationDecl", boost::python::no_init);
}