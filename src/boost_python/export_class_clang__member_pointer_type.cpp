...
void export_class_clang__member_pointer_type()
{
    ...
    boost::python::class_< ::clang::MemberPointerType, ::clang::MemberPointerType*, boost::python::bases< ::clang::Type, ::llvm::FoldingSetNode >, boost::noncopyable >("MemberPointerType", boost::python::no_init);
}