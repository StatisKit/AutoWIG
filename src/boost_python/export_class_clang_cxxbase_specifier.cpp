...
void export_class_clang_cxxbase_specifier()
{
    ...
    boost::python::class_< ::clang::CXXBaseSpecifier, ::clang::CXXBaseSpecifier *, boost::noncopyable >("CXXBaseSpecifier", boost::python::no_init)
        .def("get_access_specifier", &::clang::CXXBaseSpecifier::getAccessSpecifier)
        .def("get_type", &::clang::CXXBaseSpecifier::getType);
}