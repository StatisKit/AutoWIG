...
void export_class_llvm__folding_set_impl__node()
{
    ...
    std::string FoldingSetImpl_f91cf25f_8a4e_5dc3_8329_ea2796128ba6_name = boost::python::extract< std::string >(boost::python::scope().attr("__name__") + ".FoldingSetImpl");
    ...
    boost::python::scope().attr("FoldingSetImpl") = FoldingSetImpl_f91cf25f_8a4e_5dc3_8329_ea2796128ba6_module;
