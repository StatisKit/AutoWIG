...
void export_class_clang__template_specialization_type()
{
    ...
    boost::python::class_< ::clang::TemplateSpecializationType, ::clang::TemplateSpecializationType*, boost::python::bases< ::clang::Type, ::llvm::FoldingSetNode >, boost::noncopyable >("TemplateSpecializationType", boost::python::no_init);
}