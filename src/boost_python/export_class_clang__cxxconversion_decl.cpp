...
void export_class_clang__cxxconversion_decl()
{
    ...
    boost::python::class_< ::clang::CXXConversionDecl, ::clang::CXXConversionDecl*, boost::python::bases< ::clang::CXXMethodDecl >, boost::noncopyable >("CXXConversionDecl", boost::python::no_init);
}