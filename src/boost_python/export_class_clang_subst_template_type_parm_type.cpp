...
void export_class_clang_subst_template_type_parm_type()
{
    ...
    boost::python::class_< ::clang::SubstTemplateTypeParmType, ::clang::SubstTemplateTypeParmType *, boost::python::bases< ::clang::Type, ::llvm::FoldingSetNode >, boost::noncopyable >("SubstTemplateTypeParmType", boost::python::no_init);
}