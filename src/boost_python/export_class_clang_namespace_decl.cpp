...
void export_class_clang_namespace_decl()
{
    ...
    boost::python::class_< ::clang::NamespaceDecl, ::clang::NamespaceDecl *, boost::python::bases< ::clang::NamedDecl, ::clang::DeclContext >, boost::noncopyable >("NamespaceDecl", boost::python::no_init);
}