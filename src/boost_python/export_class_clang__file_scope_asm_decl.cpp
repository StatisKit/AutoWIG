...
void export_class_clang__file_scope_asm_decl()
{
    ...
    boost::python::class_< ::clang::FileScopeAsmDecl, ::clang::FileScopeAsmDecl*, boost::python::bases< ::clang::Decl >, boost::noncopyable >("FileScopeAsmDecl", boost::python::no_init);
}