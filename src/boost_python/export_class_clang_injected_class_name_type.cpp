...
void export_class_clang_injected_class_name_type()
{
    ...
    boost::python::class_< ::clang::InjectedClassNameType, ::clang::InjectedClassNameType *, boost::python::bases< ::clang::Type >, boost::noncopyable >("InjectedClassNameType", boost::python::no_init);
}