...
void export_class_clang__template_type_parm_type()
{
    ...
    boost::python::class_< ::clang::TemplateTypeParmType, ::clang::TemplateTypeParmType*, boost::python::bases< ::clang::Type, ::llvm::FoldingSetNode >, boost::noncopyable >("TemplateTypeParmType", boost::python::no_init);
}