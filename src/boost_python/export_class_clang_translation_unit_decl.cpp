...
void export_class_clang_translation_unit_decl()
{
    ...
    boost::python::class_< ::clang::TranslationUnitDecl, ::clang::TranslationUnitDecl *, boost::python::bases< ::clang::Decl, ::clang::DeclContext >, boost::noncopyable >("TranslationUnitDecl", boost::python::no_init);
}