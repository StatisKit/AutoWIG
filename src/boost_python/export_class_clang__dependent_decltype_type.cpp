...
void export_class_clang__dependent_decltype_type()
{
    ...
    boost::python::class_< ::clang::DependentDecltypeType, ::clang::DependentDecltypeType*, boost::python::bases< ::clang::DecltypeType, ::llvm::FoldingSetNode >, boost::noncopyable >("DependentDecltypeType", boost::python::no_init);
}