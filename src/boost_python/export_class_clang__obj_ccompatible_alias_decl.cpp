...
void export_class_clang__obj_ccompatible_alias_decl()
{
    ...
    boost::python::class_< ::clang::ObjCCompatibleAliasDecl, ::clang::ObjCCompatibleAliasDecl*, boost::python::bases< ::clang::NamedDecl >, boost::noncopyable >("ObjCCompatibleAliasDecl", boost::python::no_init);
}