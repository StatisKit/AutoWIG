...
void export_class_clang_var_template_decl()
{
    ...
    boost::python::class_< ::clang::VarTemplateDecl, ::clang::VarTemplateDecl *, boost::python::bases< ::clang::RedeclarableTemplateDecl >, boost::noncopyable >("VarTemplateDecl", boost::python::no_init);
}