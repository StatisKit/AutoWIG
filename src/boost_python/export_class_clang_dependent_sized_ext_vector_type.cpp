...
void export_class_clang_dependent_sized_ext_vector_type()
{
    ...
    boost::python::class_< ::clang::DependentSizedExtVectorType, ::clang::DependentSizedExtVectorType *, boost::python::bases< ::clang::Type, ::llvm::FoldingSetNode >, boost::noncopyable >("DependentSizedExtVectorType", boost::python::no_init);
}