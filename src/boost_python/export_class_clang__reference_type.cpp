...
void export_class_clang__reference_type()
{
    ...
    boost::python::class_< ::clang::ReferenceType, ::clang::ReferenceType*, boost::python::bases< ::clang::Type, ::llvm::FoldingSetNode >, boost::noncopyable >("ReferenceType", boost::python::no_init)
        .def("get_pointee_type_as_written", &::clang::ReferenceType::getPointeeTypeAsWritten);
}