...
void export_class_clang__adjusted_type()
{
    ...
    boost::python::class_< ::clang::AdjustedType, ::clang::AdjustedType*, boost::python::bases< ::clang::Type, ::llvm::FoldingSetNode >, boost::noncopyable >("AdjustedType", boost::python::no_init);
}