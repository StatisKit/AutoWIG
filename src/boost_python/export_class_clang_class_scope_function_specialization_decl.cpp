...
void export_class_clang_class_scope_function_specialization_decl()
{
    ...
    boost::python::class_< ::clang::ClassScopeFunctionSpecializationDecl, ::clang::ClassScopeFunctionSpecializationDecl *, boost::python::bases< ::clang::Decl >, boost::noncopyable >("ClassScopeFunctionSpecializationDecl", boost::python::no_init);
}