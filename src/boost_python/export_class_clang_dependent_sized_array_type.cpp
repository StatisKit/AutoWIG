...
void export_class_clang_dependent_sized_array_type()
{
    ...
    boost::python::class_< ::clang::DependentSizedArrayType, ::clang::DependentSizedArrayType *, boost::python::bases< ::clang::ArrayType >, boost::noncopyable >("DependentSizedArrayType", boost::python::no_init);
}