...
void export_class_clang__unary_transform_type()
{
    ...
    boost::python::class_< ::clang::UnaryTransformType, ::clang::UnaryTransformType*, boost::python::bases< ::clang::Type >, boost::noncopyable >("UnaryTransformType", boost::python::no_init);
}