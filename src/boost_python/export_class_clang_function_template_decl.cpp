...
void export_class_clang_function_template_decl()
{
    ...
    boost::python::class_< ::clang::FunctionTemplateDecl, ::clang::FunctionTemplateDecl *, boost::python::bases< ::clang::RedeclarableTemplateDecl >, boost::noncopyable >("FunctionTemplateDecl", boost::python::no_init);
}