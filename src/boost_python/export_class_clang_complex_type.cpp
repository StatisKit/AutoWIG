...
void export_class_clang_complex_type()
{
    ...
    boost::python::class_< ::clang::ComplexType, ::clang::ComplexType *, boost::python::bases< ::clang::Type, ::llvm::FoldingSetNode >, boost::noncopyable >("ComplexType", boost::python::no_init);
}