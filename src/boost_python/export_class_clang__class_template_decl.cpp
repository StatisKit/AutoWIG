...
void export_class_clang__class_template_decl()
{
    ...
    boost::python::class_< ::clang::ClassTemplateDecl, ::clang::ClassTemplateDecl*, boost::python::bases< ::clang::RedeclarableTemplateDecl >, boost::noncopyable >("ClassTemplateDecl", boost::python::no_init);
}