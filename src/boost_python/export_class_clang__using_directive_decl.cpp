...
void export_class_clang__using_directive_decl()
{
    ...
    boost::python::class_< ::clang::UsingDirectiveDecl, ::clang::UsingDirectiveDecl*, boost::python::bases< ::clang::NamedDecl >, boost::noncopyable >("UsingDirectiveDecl", boost::python::no_init);
}