...
void export_class_clang__obj_ccategory_decl()
{
    ...
    boost::python::class_< ::clang::ObjCCategoryDecl, ::clang::ObjCCategoryDecl*, boost::python::bases< ::clang::ObjCContainerDecl >, boost::noncopyable >("ObjCCategoryDecl", boost::python::no_init);
}