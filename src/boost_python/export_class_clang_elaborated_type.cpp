...
void export_class_clang_elaborated_type()
{
    ...
    boost::python::class_< ::clang::ElaboratedType, ::clang::ElaboratedType *, boost::python::bases< ::clang::TypeWithKeyword, ::llvm::FoldingSetNode >, boost::noncopyable >("ElaboratedType", boost::python::no_init)
        .def("get_named_type", &::clang::ElaboratedType::getNamedType)
        .def("desugar", &::clang::ElaboratedType::desugar);
}