...
void export_class_clang_pack_expansion_type()
{
    ...
    boost::python::class_< ::clang::PackExpansionType, ::clang::PackExpansionType *, boost::python::bases< ::clang::Type, ::llvm::FoldingSetNode >, boost::noncopyable >("PackExpansionType", boost::python::no_init);
}