...
void export_class_clang_obj_cobject_pointer_type()
{
    ...
    boost::python::class_< ::clang::ObjCObjectPointerType, ::clang::ObjCObjectPointerType *, boost::python::bases< ::clang::Type, ::llvm::FoldingSetNode >, boost::noncopyable >("ObjCObjectPointerType", boost::python::no_init);
}