...
void export_class_clang__obj_cprotocol_decl()
{
    ...
    boost::python::class_< ::clang::ObjCProtocolDecl, ::clang::ObjCProtocolDecl*, boost::python::bases< ::clang::ObjCContainerDecl >, boost::noncopyable >("ObjCProtocolDecl", boost::python::no_init);
}