...
void export_class_clang__template_template_parm_decl()
{
    ...
    boost::python::class_< ::clang::TemplateTemplateParmDecl, ::clang::TemplateTemplateParmDecl*, boost::python::bases< ::clang::TemplateDecl >, boost::noncopyable >("TemplateTemplateParmDecl", boost::python::no_init);
}