...
void export_class_clang__obj_ccategory_impl_decl()
{
    ...
    boost::python::class_< ::clang::ObjCCategoryImplDecl, ::clang::ObjCCategoryImplDecl*, boost::python::bases< ::clang::ObjCImplDecl >, boost::noncopyable >("ObjCCategoryImplDecl", boost::python::no_init);
}