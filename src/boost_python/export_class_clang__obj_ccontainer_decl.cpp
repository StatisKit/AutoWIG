...
void export_class_clang__obj_ccontainer_decl()
{
    ...
    boost::python::class_< ::clang::ObjCContainerDecl, ::clang::ObjCContainerDecl*, boost::python::bases< ::clang::NamedDecl, ::clang::DeclContext >, boost::noncopyable >("ObjCContainerDecl", boost::python::no_init);
}