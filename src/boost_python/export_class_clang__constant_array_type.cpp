...
void export_class_clang__constant_array_type()
{
    ...
    boost::python::class_< ::clang::ConstantArrayType, ::clang::ConstantArrayType*, boost::python::bases< ::clang::ArrayType >, boost::noncopyable >("ConstantArrayType", boost::python::no_init);
}