...
void export_class_clang_indirect_field_decl()
{
    ...
    boost::python::class_< ::clang::IndirectFieldDecl, ::clang::IndirectFieldDecl *, boost::python::bases< ::clang::ValueDecl >, boost::noncopyable >("IndirectFieldDecl", boost::python::no_init);
}