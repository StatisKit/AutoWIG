...
void export_class_clang__pointer_type()
{
    ...
    boost::python::class_< ::clang::PointerType, ::clang::PointerType*, boost::python::bases< ::clang::Type, ::llvm::FoldingSetNode >, boost::noncopyable >("PointerType", boost::python::no_init)
        .def("get_pointee_type", &::clang::PointerType::getPointeeType);
}