...
void export_class_clang_rvalue_reference_type()
{
    ...
    boost::python::class_< ::clang::RValueReferenceType, ::clang::RValueReferenceType *, boost::python::bases< ::clang::ReferenceType >, boost::noncopyable >("RValueReferenceType", boost::python::no_init);
}