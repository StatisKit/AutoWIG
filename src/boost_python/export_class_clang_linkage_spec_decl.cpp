...
void export_class_clang_linkage_spec_decl()
{
    ...
    boost::python::class_< ::clang::LinkageSpecDecl, ::clang::LinkageSpecDecl *, boost::python::bases< ::clang::Decl, ::clang::DeclContext >, boost::noncopyable >("LinkageSpecDecl", boost::python::no_init)
        .def("get_language", &::clang::LinkageSpecDecl::getLanguage);
}