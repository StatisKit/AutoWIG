...
void export_class_clang__var_template_partial_specialization_decl()
{
    ...
    boost::python::class_< ::clang::VarTemplatePartialSpecializationDecl, ::clang::VarTemplatePartialSpecializationDecl*, boost::python::bases< ::clang::VarTemplateSpecializationDecl >, boost::noncopyable >("VarTemplatePartialSpecializationDecl", boost::python::no_init);
}