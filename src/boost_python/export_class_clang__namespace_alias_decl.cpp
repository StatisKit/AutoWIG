...
void export_class_clang__namespace_alias_decl()
{
    ...
    boost::python::class_< ::clang::NamespaceAliasDecl, ::clang::NamespaceAliasDecl*, boost::python::bases< ::clang::NamedDecl >, boost::noncopyable >("NamespaceAliasDecl", boost::python::no_init);
}