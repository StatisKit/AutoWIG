...
void export_class_clang_ompthread_private_decl()
{
    ...
    boost::python::class_< ::clang::OMPThreadPrivateDecl, ::clang::OMPThreadPrivateDecl *, boost::python::bases< ::clang::Decl >, boost::noncopyable >("OMPThreadPrivateDecl", boost::python::no_init);
}