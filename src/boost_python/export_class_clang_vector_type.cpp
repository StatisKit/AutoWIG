...
void export_class_clang_vector_type()
{
    ...
    boost::python::class_< ::clang::VectorType, ::clang::VectorType *, boost::python::bases< ::clang::Type, ::llvm::FoldingSetNode >, boost::noncopyable >("VectorType", boost::python::no_init);
}