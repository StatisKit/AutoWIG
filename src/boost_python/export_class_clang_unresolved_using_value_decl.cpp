...
void export_class_clang_unresolved_using_value_decl()
{
    ...
    boost::python::class_< ::clang::UnresolvedUsingValueDecl, ::clang::UnresolvedUsingValueDecl *, boost::python::bases< ::clang::ValueDecl >, boost::noncopyable >("UnresolvedUsingValueDecl", boost::python::no_init);
}