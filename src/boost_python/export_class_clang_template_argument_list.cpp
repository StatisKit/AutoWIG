...
void export_class_clang_template_argument_list()
{
    ...
    boost::python::class_< ::clang::TemplateArgumentList, ::clang::TemplateArgumentList *, boost::noncopyable >("TemplateArgumentList", boost::python::no_init)
        .def("get", &::clang::TemplateArgumentList::get, boost::python::return_value_policy< boost::python::reference_existing_object >())
