...
void export_class_clang_field_decl()
{
    ...
    boost::python::class_< ::clang::FieldDecl, ::clang::FieldDecl *, boost::python::bases< ::clang::DeclaratorDecl >, boost::noncopyable >("FieldDecl", boost::python::no_init)
        .def("is_mutable", &::clang::FieldDecl::isMutable);
}