...
void export_class_clang_obj_cinterface_type()
{
    ...
    boost::python::class_< ::clang::ObjCInterfaceType, ::clang::ObjCInterfaceType *, boost::python::bases< ::clang::ObjCObjectType >, boost::noncopyable >("ObjCInterfaceType", boost::python::no_init);
}