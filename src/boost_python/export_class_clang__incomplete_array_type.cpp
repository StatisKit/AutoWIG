...
void export_class_clang__incomplete_array_type()
{
    ...
    boost::python::class_< ::clang::IncompleteArrayType, ::clang::IncompleteArrayType*, boost::python::bases< ::clang::ArrayType >, boost::noncopyable >("IncompleteArrayType", boost::python::no_init);
}