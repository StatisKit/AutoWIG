...
void export_class_clang__obj_cmethod_decl()
{
    ...
    boost::python::class_< ::clang::ObjCMethodDecl, ::clang::ObjCMethodDecl*, boost::python::bases< ::clang::NamedDecl, ::clang::DeclContext >, boost::noncopyable >("ObjCMethodDecl", boost::python::no_init);
}