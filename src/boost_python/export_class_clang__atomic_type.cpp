...
void export_class_clang__atomic_type()
{
    ...
    boost::python::class_< ::clang::AtomicType, ::clang::AtomicType*, boost::python::bases< ::clang::Type, ::llvm::FoldingSetNode >, boost::noncopyable >("AtomicType", boost::python::no_init);
}