...
void export_class_clang__enum_constant_decl()
{
    ...
    boost::python::class_< ::clang::EnumConstantDecl, ::clang::EnumConstantDecl*, boost::python::bases< ::clang::ValueDecl >, boost::noncopyable >("EnumConstantDecl", boost::python::no_init);
}