...
void export_class_clang_class_template_partial_specialization_decl()
{
    ...
    boost::python::class_< ::clang::ClassTemplatePartialSpecializationDecl, ::clang::ClassTemplatePartialSpecializationDecl *, boost::python::bases< ::clang::ClassTemplateSpecializationDecl >, boost::noncopyable >("ClassTemplatePartialSpecializationDecl", boost::python::no_init);
}