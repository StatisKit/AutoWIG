...
void export_class_clang__msproperty_decl()
{
    ...
    boost::python::class_< ::clang::MSPropertyDecl, ::clang::MSPropertyDecl*, boost::python::bases< ::clang::DeclaratorDecl >, boost::noncopyable >("MSPropertyDecl", boost::python::no_init);
}