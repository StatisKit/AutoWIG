...
void export_class_clang_type_alias_decl()
{
    ...
    boost::python::class_< ::clang::TypeAliasDecl, ::clang::TypeAliasDecl *, boost::python::bases< ::clang::TypedefNameDecl >, boost::noncopyable >("TypeAliasDecl", boost::python::no_init);
}