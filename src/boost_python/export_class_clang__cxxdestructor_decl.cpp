...
void export_class_clang__cxxdestructor_decl()
{
    ...
    boost::python::class_< ::clang::CXXDestructorDecl, ::clang::CXXDestructorDecl*, boost::python::bases< ::clang::CXXMethodDecl >, boost::noncopyable >("CXXDestructorDecl", boost::python::no_init);
}