...
void export_class_clang_lvalue_reference_type()
{
    ...
    boost::python::class_< ::clang::LValueReferenceType, ::clang::LValueReferenceType *, boost::python::bases< ::clang::ReferenceType >, boost::noncopyable >("LValueReferenceType", boost::python::no_init);
}