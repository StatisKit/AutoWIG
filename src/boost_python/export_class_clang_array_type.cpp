...
void export_class_clang_array_type()
{
    ...
    boost::python::class_< ::clang::ArrayType, ::clang::ArrayType *, boost::python::bases< ::clang::Type, ::llvm::FoldingSetNode >, boost::noncopyable >("ArrayType", boost::python::no_init);
}