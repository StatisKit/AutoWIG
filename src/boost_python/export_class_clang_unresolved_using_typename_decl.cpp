...
void export_class_clang_unresolved_using_typename_decl()
{
    ...
    boost::python::class_< ::clang::UnresolvedUsingTypenameDecl, ::clang::UnresolvedUsingTypenameDecl *, boost::python::bases< ::clang::TypeDecl >, boost::noncopyable >("UnresolvedUsingTypenameDecl", boost::python::no_init);
}