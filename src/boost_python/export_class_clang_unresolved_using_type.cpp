...
void export_class_clang_unresolved_using_type()
{
    ...
    boost::python::class_< ::clang::UnresolvedUsingType, ::clang::UnresolvedUsingType *, boost::python::bases< ::clang::Type >, boost::noncopyable >("UnresolvedUsingType", boost::python::no_init);
}