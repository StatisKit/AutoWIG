...
void export_class_clang__obj_cproperty_decl()
{
    ...
    boost::python::class_< ::clang::ObjCPropertyDecl, ::clang::ObjCPropertyDecl*, boost::python::bases< ::clang::NamedDecl >, boost::noncopyable >("ObjCPropertyDecl", boost::python::no_init);
}