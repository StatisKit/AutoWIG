...
void export_class_clang_function_no_proto_type()
{
    ...
    boost::python::class_< ::clang::FunctionNoProtoType, ::clang::FunctionNoProtoType *, boost::python::bases< ::clang::FunctionType, ::llvm::FoldingSetNode >, boost::noncopyable >("FunctionNoProtoType", boost::python::no_init);
}